...
kpattern_from_json_file!(pub(crate), cube4x4x4_orientation_canonicalization, "4x4x4.orientation-canonicalization-pattern.json", cube4x4x4_kpuzzle());
// TODO: This should be in `4x4x4.kpuzzle.json` once we can support it.
kpattern_from_json_file!(pub(crate), cube4x4x4_solved, "4x4x4.solved-pattern.json", cube4x4x4_kpuzzle());
