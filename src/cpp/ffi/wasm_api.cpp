...
extern "C" void wasm_api_reset() { ffi_api_reset(); }

extern "C" void wasm_api_set_arg(const char *s) { ffi_api_cstr_set_arg(s); }
...
extern "C" void
emscripten_notify_memory_growth([[maybe_unused]] std::size_t _) {
  // Do nothing.
}
