...
// use crate::{
//     _internal::{
//         options::MetricEnum, puzzle_traits::SemiGroupActionPuzzle, Depth, FlatMoveIndex,
//         IndexedVec, PatternValidityChecker, PruneTable, SearchGenerators,
//     },
...
// use super::{
//     coordinate_lookup_table::SemanticCoordinate,
//     definitions::square1_square_square_shape_kpattern,
//     mask_pattern::mask,
...
//     coordinates_to_index: HashMap<Square1Phase1CompoundSemanticCoordinate, PhaseCoordinatesIndex>,
...
//     #[allow(unused)]
//     pub index_to_coordinates:
//         IndexedVec<PhaseCoordinatesIndex, Square1Phase1CompoundSemanticCoordinate>, // TODO: support optimizations when the size is known ahead of time
// }
...
//             .get(
//                 &Square1Phase1CompoundSemanticCoordinate::try_new(
//                     self.data.
//                     kpattern,
//                 )
//                 .unwrap(),
...
//         IndexedVec::<PhaseCoordinatesIndex, Square1Phase1CompoundSemanticCoordinate>::default();
//     let mut coordinates_to_index =
//         HashMap::<Square1Phase1CompoundSemanticCoordinate, PhaseCoordinatesIndex>::default();
...
//             Square1Phase1CompoundSemanticCoordinate::try_new(&full_pattern, phase_mask)
//         else {
//             continue;
//         };
...
//                 Square1Phase1CompoundSemanticCoordinate::try_new(&new_representative, phase_mask)
...
// pub struct Square1Phase1PruneTableOld {
//     tpuzzle: Square1Phase1LookupTable, // TODO: store just the prune table here
// }

// impl PruneTable<Square1Phase1LookupTable> for Square1Phase1PruneTableOld {
//     fn new(
...
//                     PhaseCoordinatesIndex, Square1Phase1CompoundSemanticCoordinate,
//                 },
//             },
...
//         let other_lookup_pattern = &Square1Phase1CompoundSemanticCoordinate::try_new(
//             &other_pattern,
